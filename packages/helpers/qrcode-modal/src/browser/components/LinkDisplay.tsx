...
import { IMobileRegistryEntry, IQRCodeModalOptions } from "nptconnect-types";
import { isAndroid, formatIOSMobile, saveMobileLinkInfo } from "nptconnect-browser-utils";
